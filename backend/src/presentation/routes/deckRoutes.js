...
router.get('/', authMiddleware, deckController.getAllDecksByUserId.bind(deckController));

// Lấy chi tiết một bộ thẻ cụ thể
// GET /api/decks/:id
// router.get('/:id', deckController.getDeckById.bind(deckController));
router.get('/:id', authMiddleware, deckController.getDeckById.bind(deckController));

// Tạo mới một bộ thẻ
// POST /api/decks
// router.post('/', deckController.createDeck.bind(deckController));
router.post('/', authMiddleware, deckController.createDeck.bind(deckController));

// Cập nhật thông tin bộ thẻ
// PUT /api/decks/:id
// router.put('/:id', deckController.updateDeck.bind(deckController));
router.put('/:id', authMiddleware, deckController.updateDeck.bind(deckController));

// Xóa tạm thời (Cho vào thùng rác)
// DELETE /api/decks/:id
// router.delete('/:id', deckController.softDeleteDeck.bind(deckController));
router.delete('/:id', authMiddleware, deckController.softDeleteDeck.bind(deckController));
...
router.patch('/:id/restore', authMiddleware, deckController.restoreDeck.bind(deckController));

// Xóa vĩnh viễn khỏi Database
// DELETE /api/decks/:id/hard
// router.delete('/:id/hard', deckController.hardDeleteDeck.bind(deckController));
router.delete('/:id/hard', authMiddleware, deckController.hardDeleteDeck.bind(deckController));
